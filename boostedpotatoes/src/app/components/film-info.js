        ...
        <div className="hero min-h-screen max-w-5xl bg-indigo-500">
            <div>
                    ...
                    <div className="flex ">
                        <div className="w-auto mx-2">
                            ...
                            <div class="flex">
                                ...
                                <p class="ml-2 mr-2 text-sm font-bold text-gray-900 dark:text-white">{details.vote_average}</p>
                                <p class="text-sm mr-2 w-max font-medium text-gray-900 dark:text-white">{details.vote_count} reviews</p>
                               
                            
                            </div>
                        </div>
                        <div className='w-auto'>
                            <h1 className= "mr-3 text-center text-2xl font-bold w-max">Your Rating</h1>
                ...
                <div className='flex m-auto'>
                    <img src={details.poster_path} className="w-1/6 h-1/6 rounded-lg shadow-2xl mr-4 ml-44" />
                    <iframe width="450" height="253" src={details.trailer} title="Under The Skin | Official Trailer HD | A24" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </div>
                <div className='mt-4'>
